...
if ( !function_exists( 'pastore_church_template_team_2_theme_setup' ) ) {
	add_action( 'pastore_church_action_before_init_theme', 'pastore_church_template_team_2_theme_setup', 1 );
	function pastore_church_template_team_2_theme_setup() {
		pastore_church_add_template(array(
			'layout' => 'team-2',
			'template' => 'team-2',
			'mode'   => 'team',
			/*'container_classes' => 'sc_slider_pagination sc_slider_pagination_bottom sc_slider_nocontrols',*/
			'title'  => esc_html__('Team /Style 2/', 'pastore-church'),
...
// Template output
if ( !function_exists( 'pastore_church_template_team_2_output' ) ) {
	function pastore_church_template_team_2_output($post_options, $post_data) {
		$show_title = true;
