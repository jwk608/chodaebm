...
if ( !function_exists( 'pastore_church_template_team_3_theme_setup' ) ) {
	add_action( 'pastore_church_action_before_init_theme', 'pastore_church_template_team_3_theme_setup', 1 );
	function pastore_church_template_team_3_theme_setup() {
		pastore_church_add_template(array(
			'layout' => 'team-3',
			'template' => 'team-3',
			'mode'   => 'team',
			/*'container_classes' => 'sc_slider_nopagination sc_slider_controls sc_slider_controls_side',*/
			'title'  => esc_html__('Team /Style 3/', 'pastore-church'),
...
// Template output
if ( !function_exists( 'pastore_church_template_team_3_output' ) ) {
	function pastore_church_template_team_3_output($post_options, $post_data) {
		$show_title = true;
