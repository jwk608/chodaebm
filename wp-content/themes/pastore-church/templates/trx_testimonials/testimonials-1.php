...
if ( !function_exists( 'pastore_church_template_testimonials_1_theme_setup' ) ) {
	add_action( 'pastore_church_action_before_init_theme', 'pastore_church_template_testimonials_1_theme_setup', 1 );
	function pastore_church_template_testimonials_1_theme_setup() {
		pastore_church_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 1/', 'pastore-church'),
...
// Template output
if ( !function_exists( 'pastore_church_template_testimonials_1_output' ) ) {
	function pastore_church_template_testimonials_1_output($post_options, $post_data) {
		$show_title = true;
