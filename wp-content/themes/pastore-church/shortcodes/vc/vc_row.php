...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by Pastore Church
	 * @var $inverse	- added by Pastore Church
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by Pastore Church:
	// Color scheme
	if ($scheme && !pastore_church_param_is_off($scheme) && !pastore_church_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !pastore_church_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add Pastore Church color scheme in the row
	if ($scheme && !pastore_church_param_is_off($scheme) && !pastore_church_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
