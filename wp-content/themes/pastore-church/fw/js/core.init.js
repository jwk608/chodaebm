...
function pastore_church_ready_actions() {
	...
	// Prepare menus
	if (PASTORE_CHURCH_STORAGE['menu_cache']) pastore_church_prepare_menus();
	...
	jQuery('.popup_form.login_form').submit(function(e){
		"use strict";
		var rez = pastore_church_login_validate(jQuery(this));
		if (!rez)
			e.preventDefault();
		return rez;
	});
	...
	jQuery('.popup_form.registration_form').submit(function(e){
		"use strict";
		var rez = pastore_church_registration_validate(jQuery(this));
		if (!rez)
			e.preventDefault();
		return rez;
	});
